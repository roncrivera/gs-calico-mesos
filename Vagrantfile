...
calicoctl_url = "https://github.com/projectcalico/calicoctl/releases/download/v1.6.4/calicoctl"
...
Vagrant.configure("2") do |config|
  ...
  (1..num_instances).each do |i|
    ...
    config.vm.define vm_name do |host|
      ...
      host.vm.provision :shell, inline: "curl -L -o /opt/cni/bin/calico https://github.com/projectcalico/cni-plugin/releases/download/v1.11.6/calico"
      host.vm.provision :shell, inline: "curl -L -o /opt/cni/bin/calico-ipam https://github.com/projectcalico/cni-plugin/releases/download/v1.11.6/calico-ipam"
